 ...
 * @date 2024-06-15
 */
@Api(tags = "02-作品信息", value = "活动模块中的作品信息API")
@RestController
...
public class ActiveWorksController extends BaseController
{
     ...
     * 查询作品列表
     */
    @ApiOperation(value = "分页查询", notes = "分页查询作品信息")
     ...
     * 导出作品列表
     */
    @ApiOperation(value = "导出作品", notes = "导出作品列表信息")
     ...
     * 获取作品信息
     */
    @ApiOperation(value = "查询作品", notes = "通过id查询作品信息")
    @ApiImplicitParam(name = "workId", value = "作品ID", required = true, type = "Long")
     ...
     * 删除作品
     */
    @ApiOperation(value = "删除作品", notes = "通过id删除作品信息")
    @ApiImplicitParam(name = "workIds", value = "作品ID", required = true, type = "Long")
