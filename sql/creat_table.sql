...
VALUES (2, '作品图片', '作品图片.png', '../uploadPath/active/2/作品图片.png'),
       (2, '视频', '视频1.mkv', '../uploadPath/active/2/videos/视频1.mkv'),
       (2, '视频', '视频2.mkv', '../uploadPath/active/2/videos/视频2.mkv'),
       (2, '视频', '视频3.mkv', '../uploadPath/active/2/videos/视频3.mkv'),
       (2, '视频', '视频4.mkv', '../uploadPath/active/2/videos/视频4.mkv'),
       (2, '教案', '教案.docx', '../uploadPath/active/2/教案.docx'),
       (2, '教学实施报告', '教学实施报告.pdf', '../uploadPath/active/2/教学实施报告.pdf'),
       (2, '专业人才培养方案', '专业人才培养方案.docx', '../uploadPath/active/2/专业人才培养方案.docx'),
       (2, '课程标准', '课程标准.pdf', '../uploadPath/active/2/课程标准.pdf'),
       (2, '其他附件', '其他附件1.pdf', '../uploadPath/active/2/other/其他附件1.pdf'),
       (2, '其他附件', '其他附件2.pdf', '../uploadPath/active/2/other/其他附件2.pdf'),
       (2, '其他附件', '其他附件3.pdf', '../uploadPath/active/2/other/其他附件3.pdf'),

       (3, '作品图片', '作品图片.png', '../uploadPath/active/3/作品图片.png'),
       (3, '视频', '视频1.mkv', '../uploadPath/active/3/videos/视频1.mkv'),
       (3, '视频', '视频2.mkv', '../uploadPath/active/3/videos/视频2.mkv'),
       (3, '视频', '视频3.mkv', '../uploadPath/active/3/videos/视频3.mkv'),
       (3, '视频', '视频4.mkv', '../uploadPath/active/3/videos/视频4.mkv'),
       (3, '教案', '教案.docx', '../uploadPath/active/3/教案.docx'),
       (3, '教学实施报告', '教学实施报告.pdf', '../uploadPath/active/3/教学实施报告.pdf'),
       (3, '专业人才培养方案', '专业人才培养方案.docx', '../uploadPath/active/3/专业人才培养方案.docx'),
       (3, '课程标准', '课程标准.pdf', '../uploadPath/active/3/课程标准.pdf'),
       (3, '其他附件', '其他附件1.pdf', '../uploadPath/active/3/other/其他附件1.pdf'),
       (3, '其他附件', '其他附件2.pdf', '../uploadPath/active/3/other/其他附件2.pdf'),
       (3, '其他附件', '其他附件3.pdf', '../uploadPath/active/3/other/其他附件3.pdf');
